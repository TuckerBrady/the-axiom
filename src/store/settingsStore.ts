...
interface SettingsState {
  ...
  // Dev-only: force the requisition store's Codex discovery gate ON even in
  // dev/testflight builds (where SHOW_DEV_TOOLS normally bypasses it), so the
  // gated production behavior can be verified on device. Ignored in production.
