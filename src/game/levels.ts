...
export const levelA1_5: LevelDefinition = {
  ...
  dataTrail: { cells: [0, 0, 0, 0, 0], headPosition: 0 },
  inputTape: [1, 0, 1, 1, 0],
...
export const levelK1_4: LevelDefinition = {
  ...
  dataTrail: { cells: [0, 0, 0, 0, 0, 0], headPosition: 0 },
...
export const levelK1_7: LevelDefinition = {
  ...
  eyeState: 'amber',
  gridWidth: 10, gridHeight: 8,
  prePlacedPieces: [prePlaced('source', 1, 3), prePlaced('terminal', 8, 6), prePlaced('bridge', 5, 5)],
