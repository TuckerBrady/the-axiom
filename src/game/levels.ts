  ...
  tutorialSteps: [
    {
      ...
      eyeState: 'blue',
      message: 'This is the Input Port. Every machine on this ship starts here. Signal originates from this point. It is fixed. You work from it.',
    ...
    },
    {
      ...
      eyeState: 'blue',
      message: 'This is the Output Port. Your objective on every level. Connect a signal path from Input Port to Output Port and the circuit locks. Emergency power comes back online.',
    ...
    },
    {
      ...
      targetRef: 'boardGrid',
      eyeState: 'amber',
      message: 'Place Conveyors in a straight line between the Input Port and Output Port. Tap a placed piece to rotate it. The signal follows orientation. Build the path.',
